...
public class Passengeractivity extends ActionBarActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startRegistration();
        BookingActivity o = new BookingActivity();
    ...
    public void jj() {
        ...
        HttpPost httppost = new HttpPost("http://test5.luminativesolutions.com/cabbooking/ws/get_user_drivers.php");
// Depends on your web service
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    httppost = new HttpPost("http://www.test5.luminativesolutions.com/cabbooking/ws/gcm/save_reg_id.php");
    ...
    void showPB(final String message) {
        ...
        runOnUiThread(new Runnable() {
            ...
            @Override
            public void run() {
                pb = new ProgressDialog(Passengeractivity.this);
