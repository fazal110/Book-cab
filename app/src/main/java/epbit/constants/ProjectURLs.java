...
public class ProjectURLs {
	...
	public static String BASE_URL = "http://test5.luminativesolutions.com/cabbooking/ws/";
	...
	//public static String LOGIN_URL_STRING ="http://test5.luminativesolutions.com/cabbooking/login_process.php";
